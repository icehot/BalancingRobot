...
#define PWM_MOT_L_Pin GPIO_PIN_1
#define PWM_MOT_L_GPIO_Port GPIOA
...
#define Encoder_L_A_GPIO_Port GPIOC
#define Encoder_L_B_Pin GPIO_PIN_7
#define Encoder_L_B_GPIO_Port GPIOC
...
#define PWM_MOT_R_Pin GPIO_PIN_15
#define PWM_MOT_R_GPIO_Port GPIOA
#define MOT_R_IN3_Pin GPIO_PIN_10
#define MOT_R_IN3_GPIO_Port GPIOC
#define MOT_R_IN4_Pin GPIO_PIN_11
#define MOT_R_IN4_GPIO_Port GPIOC
